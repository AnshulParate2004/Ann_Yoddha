...
def get_openai_client():
    ...
    return openai.OpenAI(api_key=settings.openai_api_key or CHATGPT_API_KEY)
...
def get_async_openai_client():
    ...
    return openai.AsyncOpenAI(api_key=settings.openai_api_key or CHATGPT_API_KEY)
...
async def generate_node_summary(node, model=None):
    prompt = f"""You are given a part of a document. Your task is to generate a very brief, 1-2 sentence description of the main points covered. Keep it as concise as possible!
